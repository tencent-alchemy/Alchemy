...
loss, fg_loss = test_mse(test_loader)
print('Test: Loss: {:.7f} fgLoss: {:.7f}'.format(loss, fg_loss))

'''
for epoch in range(epoch):
    loss, fg_loss = train(epoch)
    save_model(epoch)
    print('Epoch: {:03d}, Loss: {:.7f} fgLoss: {:.7f}'.format(epoch, loss, fg_loss))
